...
namespace GearGauge.Migrations
{
    ...
    [Migration("20240731083418_AddGearInventoryTag")]
    partial class AddGearInventoryTag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GearGauge.Models.GearInventoryTag", b =>
                {
                    b.Property<int>("GearInventoryId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("GearInventoryId", "TagId");

                    b.HasIndex("TagId");

                    b.ToTable("GearInventoryTags");
                });
            ...
            modelBuilder.Entity("GearGauge.Models.GearInventoryTag", b =>
                {
                    ...
                    b.HasOne("GearGauge.Models.Tag", "Tag")
                        .WithMany("GearInventoryTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GearGauge.Models.Tag", b =>
                {
                    b.Navigation("GearInventoryTags");
                });
